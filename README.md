...
|----|-----|
| **当前稳定版** | **v4.3.2** |
| **Git 分支 / Tag** | `v4.3.2`（建议打 tag `v4.3.2-stable`） |
| **OpenAPI** | `4.3.2`（`/docs`） |
...
验证：`http://localhost:8000/docs` 显示 **4.3.2**；默认管理员见启动日志。
...
| 我是… | 文档 |
|--------|------|
| **部署稳定版** | [deploy/README.md](deploy/README.md) · [部署指南](docs/04-运维文档/deployment.md) · [发布验收清单](docs/04-运维文档/v4.3.2-stable-release-checklist.md) |
| **日常运维** | [操作手册](docs/guides/operations-manual.md) · [服务启动](docs/服务启动指南.md) |
| **从 4.3.1 升级** | [UPGRADE_GUIDE_v4.3.2.md](docs/UPGRADE_GUIDE_v4.3.2.md) |
| **用 Wiki** | [wiki-user.md](docs/guides/wiki-user.md) |
| **写 Skill** | [SKILL_AUTHORING.md](docs/SKILL_AUTHORING.md) |
| **版本 / 变更** | [VERSION.md](docs/01-项目概览/VERSION.md) · [Changelog](docs/01-项目概览/changelog.md) · [v4.3.2 发布说明](docs/01-项目概览/v4.3.2-release-notes.md) |
...
| 版本 | 日期 | 主题 |
|------|------|------|
| **v4.3.2** | 2026-05 | **稳定版当前** — Superpowers + Wiki/RAG 双通路、`write_wiki` |
...
**稳定部署建议**：新环境直接 **v4.3.2**；自 v4.3.1 升级见 [升级指南](docs/UPGRADE_GUIDE_v4.3.2.md)。
...
pytest tests/test_wiki_smoke_e2e.py tests/test_superpowers_v432_e2e.py -q   # v4.3.2 冒烟
